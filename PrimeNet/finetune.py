...
# Added print to show raw arguments
print(f"Raw arguments: {os.sys.argv}")

args = parser.parse_args()

# Added print to show parsed arguments
...
if __name__ == '__main__':
    ...
    #Debug check
    print(f"Pretrain model before setting: {args.pretrain_model}")
    ...
    #Debug check
    print(f"Pretrain model before loading: {args.pretrain_model}")
