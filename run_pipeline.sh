...
# Step 1: Run mTAN interpolation on toy dataset
...
# Step 2: Find the newly generated .h5 file
H5_FILE=$(ls mTAN/src/*.h5 | sort -n | tail -1)
echo "Using generated file: $H5_FILE"

# Step 3: Run mTAN_PrimeNet_transition.py
echo "Running mTAN to PrimeNet transition..."
python3 mTAN_PrimeNet_transition.py --input_file "$H5_FILE"

# Step 4: Run pretrain.sh
